...
import com.vibhusha.userservice.repository.TwoFactorOtpRepository;
...
public class TwoFactorOtpServiceImpl implements TwoFactorOtpService {
    ...
    @Override
    public TwoFactorOTP createTwoFactorOtp(User usr, String otp, String jwt) {
